...
<div class="content container" style="margin-top:100px;">
	...
	<form name="frm1" action="${path1 }/AddUserCtrl.do" method="post"  class="frm1" onsubmit="return joinAlert(this)">
		<table class="table">
			<tbody>
				<tr>
					<th>아이디</th>
				...
				<tr>
					<th>비밀번호 확인</th>
					<td><input type="password" name="pw2" id="pw2" placeholder="비밀번호  확인 입력" class="form-control" required /></td>
				</tr>
				<tr>
					<th>회원이름</th>
				...
				<tr>
					<th>연락처</th>
					<td><input type="tel" name="tel" id="tel" maxlength="13" placeholder="010-0000-0000" class="form-control" required></td>
				</tr>
				<tr>
					<th>주소</th>
